...
tripdata = alltripdata[['trip_day','trip_hour', 'trip_duration','passenger_count','PULocationID', 'DOLocationID','trip_distance', 'fare_amount','RatecodeID','tip_amount']]
...
X = balancedtripdata[['trip_day','trip_hour', 'trip_duration','passenger_count','PULocationID', 'DOLocationID','trip_distance', 'fare_amount','RatecodeID']]
...
# Prediction with MLR to the test data
pred_logreg = train_logreg.predict(X_test_scale)
